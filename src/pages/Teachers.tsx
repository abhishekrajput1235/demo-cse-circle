...
const IMAGES = {
  ...
  sociologyTeacher: 'https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=800',
  teachingShared:   'https://images.pexels.com/photos/4145153/pexels-photo-4145153.jpeg?auto=compress&cs=tinysrgb&w=1200',
  chalkboard:       'https://images.pexels.com/photos/3729557/pexels-photo-3729557.jpeg?auto=compress&cs=tinysrgb&w=900',
  answerWriting:    'https://images.pexels.com/photos/4144923/pexels-photo-4144923.jpeg?auto=compress&cs=tinysrgb&w=600',
  evaluation:       'https://images.pexels.com/photos/1181533/pexels-photo-1181533.jpeg?auto=compress&cs=tinysrgb&w=900',
  library:          'https://images.pexels.com/photos/256395/pexels-photo-256395.jpeg?auto=compress&cs=tinysrgb&w=900',
  discussion:       'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=1200',
  studyDesk:        'https://images.pexels.com/photos/4050315/pexels-photo-4050315.jpeg?auto=compress&cs=tinysrgb&w=600',
...
const mathsTeacher = {
  ...
  testimonials: [
    { name: 'Aditya Kumar', rank: 'IAS — AIR 47, CSE 2023', score: 'Maths Optional: 312 / 500', text: 'My teacher is the most technically precise educator I have encountered — in any setting. They narrate the thinking process out loud while solving, which is exactly how a student learns to think. By Month 4 I was solving questions I would have found impossible in Month 1. Not because I worked harder — because I was taught better.' },
    { name: 'Arjun Pillai',  rank: 'IAS — AIR 67, CSE 2022', score: 'Maths Optional: 304 / 500', text: 'The PYQ analysis sessions were unlike anything I had experienced. Twice a month, the teacher would take us through a paper — explaining why certain questions appeared, what concept they were really testing, and what a perfect answer would look like. Those sessions built an examiner-awareness I could not have developed alone.' },
    { name: 'Rahul Verma',   rank: 'IRS — AIR 152, CSE 2022', score: 'Maths Optional: 287 / 500', text: 'I want to say something specific about the feedback process. My teacher writes more on my evaluated answers than I write in the answers themselves. Every evaluation is a teaching document — not a score sheet. I kept every single feedback sheet and re-read them. That was as valuable as attending new classes.' },
  ],
};
...
const sociologyTeacher = {
  ...
  testimonials: [
    { name: 'Priya Sharma', rank: 'IPS — AIR 89, CSE 2023',  score: 'Sociology Optional: 298 / 500', text: "What my teacher did that nobody else had done was make me stop treating theory as information to memorise and start treating it as a tool to use. Once that shifted — once I understood that Durkheim's idea is a lens, not a fact — my answer writing changed completely. My second-attempt score was 80 marks higher. That is entirely a teaching outcome." },
    { name: 'Sneha Iyer',   rank: 'IFS — AIR 203, CSE 2023', score: 'Sociology Optional: 275 / 500', text: 'The thing that surprised me most was how personally my teacher knew me as a student. By Month 3, they could predict — correctly — which type of question I would underperform on and exactly why. That level of individual attention is not something you get from any platform that treats teaching as content delivery.' },
    { name: 'Meera Nair',   rank: 'IRS — AIR 134, CSE 2023', score: 'Sociology Optional: 283 / 500', text: 'The "Theory + Today" sessions changed how I read the newspaper. Every morning, I could connect what I was reading to the sociological framework we had studied. By the time of the exam, answering questions felt natural — because I had been practising sociological thinking every single day, not just during study hours.' },
  ],
};
...
// Teacher Hero — portrait + bio + contextual image strip
function TeacherHero({ teacher }: { teacher: typeof mathsTeacher }) {
  return (
    <div className={`bg-gradient-to-br ${teacher.accentFrom} ${teacher.accentTo} text-white rounded-3xl overflow-hidden shadow-2xl`}>
      <div className="grid grid-cols-1 lg:grid-cols-5">
          ...
          <div>
            ...
            <div className="relative mb-7 inline-block">
              <div className="w-28 h-28 rounded-2xl overflow-hidden border-2 border-white/30 shadow-xl">
                <img
                  src={teacher.image}
                  alt={`${teacher.subject} Teacher at The CSE Circle`}
                  className="w-full h-full object-cover object-top"
                />
              </div>
              <span className="absolute -bottom-1.5 -right-1.5 bg-green-400 text-white text-xs font-bold px-2 py-0.5 rounded-full shadow">
                ● Active
              </span>
            </div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-1">{teacher.name}</h2>
            <p className="text-white/70 text-sm font-medium italic mb-6">{teacher.tagline}</p>

            <div className="space-y-3">
              {[teacher.qualification, teacher.experience, teacher.selections].map((item, i) => (
                <div key={i} className="flex items-start gap-3">
                  <CheckCircle size={15} className="text-white/60 mt-0.5 shrink-0" />
                  <span className="text-white/80 text-sm">{item}</span>
                </div>
              ))}
            </div>
        ...
        {/* Right — bio + contextual image */}
        <div className="lg:col-span-3 bg-white/5 backdrop-blur-sm p-10 flex flex-col">
          <h3 className="text-xs font-bold text-white/90 mb-6 uppercase tracking-widest">
            In the Teacher's Own Words
          </h3>
          ...
          {/* Contextual image strip at the bottom */}
          <div className="mt-8 relative h-36 rounded-xl overflow-hidden">
            <img
              src={teacher.id === 'maths' ? IMAGES.chalkboard : IMAGES.discussion}
              alt={teacher.id === 'maths' ? 'Mathematics teaching' : 'Sociology class discussion'}
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-black/65 to-transparent flex items-center px-5">
              <p className="text-white text-xs font-medium max-w-xs leading-relaxed">
                {teacher.id === 'maths'
                  ...
                  : 'Every class bridges classical sociological theory with a live Indian example.'}
              </p>
            </div>
          </div>
        </div>
...
function TopicCloud({ teacher }: { teacher: typeof mathsTeacher }) {
  return (
    <div className="flex flex-wrap gap-2">
      {teacher.topics.map((t) => (
        <span key={t} className={`${teacher.accentBadge} text-xs font-semibold px-3 py-1.5 rounded-full`}>{t}</span>
      ))}
    </div>
  );
}
    ...
    <div className="space-y-10">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {openTab === 'topics'       && (
            <div className={`rounded-2xl p-8 ${teacher.accentLight}`}>
              <p className="text-sm text-gray-500 mb-5">Every topic below is taught by the same teacher — not outsourced to different faculty across the programme.</p>
              <TopicCloud teacher={teacher} />
            </div>
          )}
          {openTab === 'testimonials' && <TestimonialRow teacher={teacher} />}
...
function AccordionItem({ question, answer, open, onClick }: {
  ...
  return (
    <div className={`border rounded-xl overflow-hidden transition-all ${open ? 'border-blue-300 shadow-md' : 'border-gray-200'}`}>
...
export default function Teachers() {
  ...
  const faqs = [
    { q: 'Will I have direct access to the teacher — or is it a TA system?',        a: "Direct access to your teacher is central to how The CSE Circle works. Live doubt sessions are conducted by the subject teacher, not teaching assistants. When you submit an answer for evaluation, it is your teacher who reads and annotates it. This is non-negotiable for us — because the teaching relationship only works when it is genuine and direct." },
    { q: 'How does the teacher personalise the programme for each student?',         a: 'In the first two weeks, the teacher conducts a diagnostic assessment — a short test or a direct conversation about your background, previous preparation, and specific weak areas. From this, they build a personalised study plan. As the programme progresses, this plan evolves based on test performance and the observation of your written work.' },
    { q: 'Does the teacher write the study material themselves?',                    a: "Yes. The study notes for both Maths Optional and Sociology Optional at The CSE Circle are written by the subject teachers — not sourced from publishers or compiled from other materials. The notes are calibrated to how the teacher explains concepts in class, making them significantly more useful as a revision tool than generic market notes." },
    { q: 'How many students does each teacher teach per batch?',                    a: "We deliberately keep batch sizes small to preserve the quality of the teaching relationship. Our teachers cannot provide genuine personalised attention to 500 students — and we do not pretend otherwise. Batch sizes are limited so that every student's answers are actually read, every doubt is actually addressed, and the teacher genuinely knows each student's preparation profile." },
    { q: 'Can I attend a demo class before enrolling?',                             a: "Yes — and we actively encourage it. A free demo class is available for both Maths Optional and Sociology Optional. Experience the teacher's style, ask them questions directly, and see how they explain a topic before you make any commitment. We have nothing to hide, and the demo class is the most honest way to evaluate whether this is the right fit for you." },
    { q: 'What if I am joining mid-preparation — will the teacher accommodate me?', a: 'Absolutely. Many students join The CSE Circle after a semester at another institute or after months of self-study. The teacher begins with a brief diagnostic to understand where you are, then builds a forward plan from that point — covering any critical gaps while ensuring you do not repeat what you have already mastered.' },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* ══════════════════════════════════════════════════════════════════
          HERO (gradient bg — no images per instruction)
      ══════════════════════════════════════════════════════════════════ */}
      <section className="relative bg-gradient-to-br from-gray-900 via-blue-950 to-gray-900 text-white overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 rounded-full bg-blue-700/10 -translate-y-1/2 translate-x-1/2 blur-3xl" />
        <div className="absolute bottom-0 left-0 w-64 h-64 rounded-full bg-indigo-600/10 translate-y-1/2 -translate-x-1/4 blur-2xl" />
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-28 text-center">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#maths-teacher">
                <Button size="lg" className="group bg-blue-600 hover:bg-blue-700">
                  Maths Optional Teacher <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={18} />
                </Button>
              </a>
              <a href="#sociology-teacher">
                <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10">
      ...
      {/* ══════════════════════════════════════════════════════════════════
          WHAT BOTH TEACHERS SHARE
          Full-width image banner → 4 skill cards
      ══════════════════════════════════════════════════════════════════ */}
      <Section className="bg-white">
        {/* Image banner with overlay text */}
        <div className="relative h-64 md:h-72 rounded-3xl overflow-hidden mb-14 shadow-xl">
          <img
            src={IMAGES.teachingShared}
            alt="Teacher and students working together"
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-gray-900/85 via-gray-900/55 to-transparent flex items-center px-10 md:px-16">
            <div className="max-w-lg">
              <p className="text-xs font-bold uppercase tracking-widest text-blue-400 mb-2">Shared Standards</p>
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-3 leading-snug">
                What Both Teachers Share
              </h2>
              <p className="text-white/70 text-sm leading-relaxed">
                Before you meet each teacher individually — here is what every student at The CSE Circle
                can expect without exception, regardless of which optional they choose.
              </p>
            </div>
          </div>
        </div>

        {/* 4 shared skill cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {sharedSkills.map((skill, i) => {
            const Icon = skill.icon;
            return (
      ...
      <Section className="bg-gradient-to-br from-blue-50 to-white" id="maths-teacher">
        ...
        {/* Section header with inline image strip */}
        <div className="flex flex-col md:flex-row md:items-center gap-5 mb-10">
          ...
          {/* Decorative image strip (desktop only) */}
          <div className="hidden md:block flex-1 h-16 rounded-xl overflow-hidden shadow-md">
            <img src={IMAGES.chalkboard} alt="Mathematics equations on chalkboard" className="w-full h-full object-cover" />
          </div>
        </div>

        <TeacherSection teacher={mathsTeacher} />

        {/* 3-image grid — teaching highlights */}
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { img: IMAGES.answerWriting, title: 'Answer Writing',   sub: 'Evaluated personally by the teacher — every single submission, with written annotations.' },
            { img: IMAGES.studyDesk,    title: 'Structured Study',  sub: 'Topics sequenced by logical dependency so each concept builds naturally on the last.' },
            { img: IMAGES.mentoring,    title: 'Direct Mentorship', sub: 'Weekly live sessions — direct access to your teacher, no TAs, no waiting queues.' },
          ].map((item, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 16 }}
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-blue-900/80 via-blue-900/30 to-transparent flex items-end p-5">
                <div>
                  <p className="text-white font-bold text-sm">{item.title}</p>
                  <p className="text-blue-200 text-xs mt-1 leading-relaxed">{item.sub}</p>
                </div>
              </div>
            </motion.div>
          ))}
      ...
      <Section className="bg-gradient-to-br from-indigo-50 to-white" id="sociology-teacher">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-5 mb-10">
          ...
          <div className="hidden md:block flex-1 h-16 rounded-xl overflow-hidden shadow-md">
            <img src={IMAGES.library} alt="Sociology books and study materials" className="w-full h-full object-cover object-center" />
          </div>
        </div>

        <TeacherSection teacher={sociologyTeacher} />

        {/* "Theory + Today" wide image strip */}
        <div className="mt-12 relative h-56 md:h-64 rounded-2xl overflow-hidden shadow-xl">
          <img
            src={IMAGES.discussion}
            alt="Students in sociological discussion and analysis"
            className="w-full h-full object-cover object-center"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-indigo-900/88 via-indigo-900/55 to-transparent flex items-center px-10">
            <div className="max-w-md">
              <p className="text-indigo-300 text-xs font-bold uppercase tracking-widest mb-2">Signature Teaching Method</p>
              <h3 className="text-white text-xl font-bold mb-3">Theory + Today</h3>
              <p className="text-white/75 text-sm leading-relaxed">
                Every class connects classical sociological theory to a live Indian example.
                By the time a student finishes this programme, their reading of the world has genuinely changed
                — and that shows in every answer they write.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ══════════════════════════════════════════════════════════════════
          TEACHING SKILLS — SIDE BY SIDE
          Layout: image column left | comparison table right
      ══════════════════════════════════════════════════════════════════ */}
      <Section className="bg-white">
        <SectionTitle
          title="Teaching Skills — Side by Side"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-4">
            <motion.div
              ...
              className="relative h-52 rounded-2xl overflow-hidden shadow-lg group"
            >
              <img src={IMAGES.mathsTeacher} alt="Maths Optional Teacher" className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-blue-900/80 to-transparent flex items-end p-5">
                <div>
                  <p className="text-white font-bold text-sm">∑ Maths Optional Teacher</p>
                  <p className="text-blue-200 text-xs">Concept-first. Proof-rooted. PYQ-anchored.</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative h-52 rounded-2xl overflow-hidden shadow-lg group"
            >
              <img src={IMAGES.sociologyTeacher} alt="Sociology Optional Teacher" className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-indigo-900/80 to-transparent flex items-end p-5">
                <div>
                  <p className="text-white font-bold text-sm">⚖ Sociology Optional Teacher</p>
                  <p className="text-indigo-200 text-xs">Analytical. Contemporary. Theory + Today.</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          {/* Comparison table */}
          <div className="lg:col-span-3 overflow-x-auto rounded-2xl border border-gray-200 shadow-sm">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-900 text-white">
                  <th className="text-left p-4 font-semibold text-gray-300 text-xs">Teaching Skill</th>
                  <th className="text-left p-4 font-semibold text-blue-400 text-xs">∑ Maths</th>
                  <th className="text-left p-4 font-semibold text-indigo-400 text-xs">⚖ Sociology</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ['Concept Explanation',   'Visual, step-by-step, proof-based with worked examples narrated aloud',                       'Narrative — thinkers taught as intellectual biographies, not definitions'],
                  ['PYQ Approach',          '20-year paper analysis; mapped by topic, difficulty, marks-per-step allocation',               "Theme & pattern analysis; examiner's preferred sociological lenses identified across years"],
                  ['Answer Writing',        'Step-by-step evaluation; marks awarded per step; presentation and legibility guidance',        '6-dimension rubric: structure, theory, evidence, relevance, critical analysis, conclusion'],
                  ['Doubt Resolution',      'Weekly live sessions — problem-solving and concept doubts addressed by teacher directly',       'Weekly live — conceptual + answer writing doubts both addressed by the teacher personally'],
                  ['Personalisation',       'Diagnostic test → topic-specific study plan → tracks weak areas across full test series',      'Writing style assessment → analytical depth evaluation → tailored improvement plan per student'],
                  ['Current Affairs',       'Real data sets integrated into Statistics, Mechanics, and Fluid Dynamics problems',             "Monthly dedicated session — recent events read through that week's sociological framework"],
                  ['Exam Strategy',         'Paper-attempt sequence; time allocation per topic; when to skip, when to attempt partially',   'Answer selection strategy; Paper I vs Paper II balance; high-probability topic identification'],
                  ['Motivation',            'Syllabus broken into small milestones; celebrates concrete skill achievements throughout',      "Connects preparation to student's vision of public service and the social problems they want to solve"],
                ].map(([skill, maths, socio], i) => (
                  <tr key={i} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    <td className="p-3 font-semibold text-gray-700 text-xs align-top">{skill}</td>
                    <td className="p-3 text-gray-600 text-xs align-top border-l border-blue-100">{maths}</td>
                    <td className="p-3 text-gray-600 text-xs align-top border-l border-indigo-100">{socio}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      {/* ══════════════════════════════════════════════════════════════════
          HOW TO EVALUATE A TEACHER
          Layout: checklist left | sticky image stack right
      ══════════════════════════════════════════════════════════════════ */}
      <Section className="bg-gradient-to-br from-gray-50 to-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">

          {/* Left — evaluation checklist */}
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-blue-600 mb-2">Before You Commit</p>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">How to Evaluate Any UPSC Optional Teacher</h2>
            <p className="text-gray-500 text-sm mb-8 leading-relaxed">
              Ask these questions of any teacher — including ours. We actively encourage it.
            </p>

            <div className="space-y-4">
              {[
                { q: 'Have they taught this specific optional for UPSC — not just the academic subject?',   a: 'A university professor is not automatically a great UPSC teacher. Ask specifically how long they have taught this optional for this examination.' },
                { q: 'Can they show you PYQ analysis — their actual reading of examiner patterns?',        a: 'A teacher who has truly studied the exam can tell you which topics appeared in 9 of the last 10 papers — and which appeared just once.' },
                { q: 'How do they evaluate answer writing — number or written feedback?',                  a: 'A marks number is not feedback. Ask to see a sample evaluated answer. Does it tell you specifically what to improve and exactly how?' },
                { q: 'Can you speak to a past student before enrolling?',                                  a: 'Any teacher with genuine results will connect you with former students. Evasiveness here is a significant warning sign.' },
                { q: 'Will you have direct access to the teacher — or to a TA?',                           a: 'Ask specifically: who answers my doubts? Who evaluates my answers? The teacher or someone else?' },
                { q: 'How have they updated their material to reflect the last 2–3 UPSC papers?',          a: 'A teacher who has not updated to reflect recent question patterns is teaching a syllabus, not an examination.' },
              ].map((item, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 12 }}
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.4, delay: i * 0.07 }}
                  className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 transition-all"
                >
                  <div className="flex gap-3 items-start">
                    <div className="w-7 h-7 rounded-full bg-blue-600 text-white text-xs font-bold flex items-center justify-center shrink-0 mt-0.5">
                      {i + 1}
            ...
            <div className="mt-8">
              <p className="text-gray-500 text-sm mb-4">We actively encourage prospective students to ask all of the above — directly to our teachers.</p>
              <Link to="/contact">
                <Button size="lg" variant="outline">Ask Our Teachers Directly →</Button>
              </Link>
            </div>
          </div>

          {/* Right — sticky image stack + CTA card */}
          <div className="space-y-5 lg:sticky lg:top-24">
            ...
            >
              <img src={IMAGES.evaluation} alt="Teacher evaluating student work" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/75 to-transparent flex items-end p-6">
                <p className="text-white text-sm font-semibold leading-snug max-w-xs">
                  "We have nothing to hide — and everything to prove. Ask us anything before you decide."
                </p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative h-44 rounded-2xl overflow-hidden shadow-xl group"
            >
              <img src={IMAGES.library} alt="Teacher-written study resources" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-indigo-900/80 to-transparent flex items-end p-5">
                <div>
                  <p className="text-white font-bold text-sm mb-1">Teacher-Written Study Notes</p>
                  <p className="text-indigo-200 text-xs leading-relaxed">Every note on this platform is written by the teacher — calibrated to exactly how they explain concepts in class.</p>
                </div>
              </div>
            </motion.div>
            ...
            <div className="bg-blue-600 rounded-2xl p-6 text-white">
              <p className="font-bold text-sm mb-2">Free Demo Class Available</p>
              <p className="text-blue-100 text-xs leading-relaxed mb-4">
                Experience the teaching before you decide. No fee, no pressure.
                One class with the actual teacher, on an actual topic.
              </p>
              <Link to="/contact">
                <Button size="sm" variant="secondary" className="w-full">Book Your Free Demo Class</Button>
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* ══════════════════════════════════════════════════════════════════
          FAQ
          Layout: accordion left | image + stats right
      ══════════════════════════════════════════════════════════════════ */}
      <Section className="bg-white">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="space-y-5 lg:sticky lg:top-24">
            <motion.div
              ...
              className="relative h-64 rounded-2xl overflow-hidden shadow-xl group"
            >
              <img src={IMAGES.mentoring} alt="One-on-one teacher mentoring" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 via-gray-900/30 to-transparent flex items-end p-6">
                <div>
                  <p className="text-white font-bold text-sm mb-1">Every Doubt. Answered Personally.</p>
                  <p className="text-gray-300 text-xs leading-relaxed">Direct access to your teacher every week — no ticket systems, no waiting rooms.</p>
                </div>
              </div>
            </motion.div>

            {[
              { num: '500+',  label: 'Students personally guided to selection' },
              { num: '100%',  label: 'Answers evaluated by the teacher — not TAs' },
              { num: 'Free',  label: 'Demo class available before any commitment' },
            ].map((s, i) => (
              <motion.div
                key={i}
      ...
      <Section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        <div className="text-center max-w-3xl mx-auto">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Experience the Teaching Before You Commit.</h2>
            <p className="text-blue-100 text-lg mb-2">Attend a free demo class. Meet your teacher in person.</p>
            <p className="text-blue-200 text-sm mb-8">No registration fee. No pressure. Just genuine teaching — so you can decide for yourself.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact">
